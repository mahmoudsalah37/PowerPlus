<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SignUp.aspx.cs" Inherits="PowerPlus_v1.SignUp" %>
       ...
       <div class="user">
        ...
        <form class="form">
            <div class="form__group">
                <input id="fullNameINP" runat="server" type="text" placeholder="الأسم بالكامل" class="form__input"/>
            </div>
            <div class="form__group">
            ...
            <div class="form__group">
                <input id="confirm_passwordINP" runat="server" type="password" placeholder="تأكيد كلمة السر" class="form__input" />
            </div>
            <div class="form__group">
                <input id="addressINP" runat="server" type="text" placeholder="العنوان بالكامل" class="form__input"/>
            </div>
            <div class="form__group">
                <input id="dateINP" runat="server" type="date" placeholder="تاريخ الميلاد" class="form__input" />
            </div>
            <div class="form__group">
                <input id="phoneNumberINP" runat="server" type="number" placeholder="رقم الهاتف" class="form__input" />
            </div>
            <asp:Button class="btn" runat="server" ID="Button1" runat="server" Text="تسجيل" OnClick="Button1_Click" />
        </form>
    </div>
    <script>
        //var d = Date(Date.now());
